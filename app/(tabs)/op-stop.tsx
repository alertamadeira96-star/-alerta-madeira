...
export default function OpStopScreen() {
  ...
  const { user } = useAuth();
  const posts = getPostsByCategory('op-stop');
  ...
  const handleCreatePost = () => {
    router.push('/post/create?category=op-stop');
  };
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <EmptyState 
            ...
            title="Sem operações stop"
            description="Ainda não há operações stop reportadas. Ajude a comunidade a estar informada!"
          />
        }
      />

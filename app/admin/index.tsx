...
import { Users, Trash2, Bell, Image as ImageIcon, Send, X, ArrowLeft, Megaphone } from 'lucide-react-native';
...
export default function AdminScreen() {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.unauthorized}>
          <Text style={styles.unauthorizedText}>Acesso não autorizado</Text>
  ...
  const handleDeleteAd = (adId: string, adTitle: string) => {
    Alert.alert(
      ...
      `Tem a certeza que deseja eliminar "${adTitle}"?`,
      [
        { text: 'Cancelar', style: 'cancel' },
        { 
          text: 'Eliminar', 
